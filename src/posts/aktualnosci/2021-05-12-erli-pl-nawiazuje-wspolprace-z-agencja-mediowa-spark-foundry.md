...
W ramach nawiązanej współpracy, agencja mediowa Spark Foundry będzie odpowiedzialna za strategiczne planowanie oraz zakup kampanii w telewizji i digitalu. Do zadań agencji należy doradztwo w zakresie prowadzenia skutecznej komunikacji marketingowej, zwłaszcza w kontekście launchu mediowego, planowanie i zakup działań wizerunkowych (kanały online i offline). Obowiązki Spark Foundry obejmują również wsparcie w obszarze performance a także przeprowadzanie badań konsumenckich. Pierwsza wspólna kampania planowana jest jeszcze w kwietniu.

*Wygrana w przetargu to z pewnością zasługa całego zespołu i naszych rekomendacji, które bazujemy na unikalnych narzędziach Grupy Publicis oraz bazie benchmarków pochodzącej z modelowań ekonometrycznych i badań konsumenckich. ERLI.pl jako nowy marketplace na polskim rynku, jest atrakcyjną alternatywą dla popularnych platform e-commerce. Bardzo się cieszymy, że właśnie taki Klient powiększa nasze portfolio, a jako agencja kierująca się ideą Spirit of Startup potrafimy i w dodatku bardzo lubimy pracować dla Klientów, którzy „challengują” rynek, ponieważ działamy w ten sam sposób – **komentuje Beata Szcześniak, General Manager Spark Foundry.***
